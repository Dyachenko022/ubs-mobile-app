...
locale={'ru'}
                ...
                <View style={{borderTopWidth: 1, borderColor: "#ddd", flexDirection: 'row'}}>
                  <Touchable onPress={this.props.onClose} style={{flex: 1, height: 50, justifyContent: 'center'}}>
        ...
        <View>
          ...
          <Input placeholder={'Не указано'} inputProps={{value: moment(this.state.chosenDate).format('DD.MM.YYYY') === '01.01.2222' ? '' : moment(this.state.chosenDate).format('DD.MM.YYYY')}}/>
        </View>
